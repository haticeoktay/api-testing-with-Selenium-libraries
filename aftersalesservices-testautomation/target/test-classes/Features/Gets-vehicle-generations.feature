@Gets
Feature: Gets vehicle/generations
  I want to be sure
  ...
  Scenario: Verify status code returned is expected
    Given I do a get to the "vehicle-generations" endpoint
    Then the returned status code is: "200"
    And the schema for the "vehicle-generations" endpoint with "200" response code is correct
  ...
  Scenario: Test for checking the response body
    ...
    And the response have value "1" equal to text "1" for "vehicle-generations" api
